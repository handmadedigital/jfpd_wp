...
class Vc_Updater {
	...
	protected function envatoDownloadPurchaseUrl( $username, $api_key, $purchase_code ) {
		...
		return 'https://marketplace.envato.com/api/edge/' . rawurlencode( $username ) . '/' . rawurlencode( $api_key ) . '/download-purchase:' . rawurlencode( $purchase_code ) . '.json';
	}
}
