...
class Vc_Updating_Manager {
	 ...
	 * @var string
	 */
	protected $url = 'https://bit.ly/vcomposer';
	...
	public function addUpgradeMessageLink() {
		...
		if ( ! $is_activated ) {
			...
			echo sprintf( ' ' . __( 'To receive automatic updates license activation is required. Please visit %s to activate your Visual Composer.', 'js_composer' ), $redirect ) . sprintf( ' <a href="https://go.wpbakery.com/faq-update-in-theme" target="_blank">%s</a>', __( 'Got Visual Composer in theme?', 'js_composer' ) );
		}
	}
}
