...
class Vc_Frontend_Editor implements Vc_Editor_Interface {
	 ...
	 * @var string
	 */
	protected static $brand_url = 'https://vc.wpbakery.com/?utm_campaign=VCplugin&utm_source=vc_user&utm_medium=frontend_editor';
	 ...
	 */
	function fullUrl( $s ) {
		$ssl = ( ! empty( $s['http'] ) && 'on' === $s['http'] ) ? true : false;
