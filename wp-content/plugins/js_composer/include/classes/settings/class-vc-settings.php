 ...
 *
 * @link https://codex.wordpress.org/Settings_API Wordpress settings API
 * @since 3.4
 */
class Vc_Settings {
	public $tabs;
	...
	public function groups_access_rules_callback() {
		...
		?>
		<div class="wpb_settings_accordion" id="wpb_js_settings_access_groups" xmlns="https://www.w3.org/1999/html">
		<?php
		if ( is_array( $groups ) ) :
