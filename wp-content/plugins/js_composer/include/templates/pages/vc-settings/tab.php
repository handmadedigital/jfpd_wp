	...
	<?php if ( 'updater' === $tab ) : ?>
		...
		<div class="vc_settings-activation-deactivation">
			...
			<?php else : ?>
				...
				<p class="description">
					<?php echo sprintf( __( 'Don\'t have direct license yet? <a href="%s" target="_blank">Purchase Visual Composer license</a>.', 'js_composer' ), esc_url( 'https://bit.ly/vcomposer' ) ) ?>
				</p>
