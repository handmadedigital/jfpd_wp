...
* Use http by default for all requests to Akismet.
...
* Fix to allow removal of http author URLs.
...
* Fix mshots preview when using http
...
* Use http for the stats IFRAME when wp-admin is using http
